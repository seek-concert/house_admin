...
<div id="wrapper">
                ...
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li>
                                <a href="javascript:edit_password()">修改密码</a>
                            </li>
                            <li>
                                <a href="{{route('g_logout')}}">安全退出</a>
                            </li>
                        </ul>
                    </div>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row content-tabs">
            ...
            <a href="{{route('g_logout')}}" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i>
                退出</a>
        </div>
        <div class="row J_mainContent" id="content-main">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%"
                    src="{{route('g_home_index')}}" frameborder="0"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title-kallocation">密码修改</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal m-t" id="edit_passwordForm" method="post" action="">
                    <div class="form-group">
                        <label class="col-sm-3 control-label">原密码：</label>
                        <div class="input-group col-sm-4">
                            <input id="used" type="text" class="form-control" name="used" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group col-sm-4">
                            <input id="password_confirm" type="text" class="form-control" name="password_confirm" required="" aria-required="true">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-6">
                            <button class="btn btn-primary" type="button" onclick="password_submit()">提交</button>
                        </div>
                    </div>
                </form>
            </div>
...
<script type="text/javascript">
    ...
    function password_submit() {
        $.ajax({
            cache: true,
            type: "POST",
            url: "{:url('admin/login/edit_password')}",
            data: $('#edit_passwordForm').serialize(),// 你的formid
            async: false,
