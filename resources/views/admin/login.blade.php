...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到后台管理系统</p>
                ...
                <div style="margin-bottom:70px">
                    ...
                    <img src="{{captcha_src()}}" onclick="javascript:this.src='{{captcha_src()}}?tm='+Math.random();" style="float:right;cursor: pointer"/>
                </div>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            温馨提示：IE9下访问可能不佳或无法正常使用，推荐使用：Chrome / Firefox / Edge 等高级浏览器，360浏览器、搜狗浏览器等建议使用极速模式&copy; {{date('Y')}} All Rights Reserved.
        </div>
    </div>
</div>
