...
<head>
    ...
    <script src="https://www.mycode5.com/index/js/html5shiv.min.js"></script>
    <script src="https://www.mycode5.com/index/js/css3-mediaqueries.js"></script>
</head>
<body class="gray-bg">
        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>添加{{$module_name}}</h5>
                </div>
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="{{$add_url}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <select class="form-control" name="role_id" required="" aria-required="true">
                                    ...
                                    @if(isset($role_arr)) @foreach($role_arr as $k=>$v)
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="realname" type="text" class="form-control" name="realname" required="" aria-required="true">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-6">
                                <div class="radio i-checks col-sm-4">
                                    <label><input type="radio" value="1" checked name="status"> <i></i> 启用</label>
                                </div>
                                <div class="radio i-checks col-sm-4">
                                    <label><input type="radio" value="-1" name="status"> <i></i> 停用</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
...
<script type="text/javascript">
    ...
    function showSuccess(res){
        layer.ready(function(){
            layer.close(index);
            if(0 == res.code){
                layer.alert(res.msg, {title: '友情提示', icon: 1, closeBtn: 0}, function(){window.location.href = res.url;});
