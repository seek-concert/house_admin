                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="{{$add_url}}">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-6">
                                ...
                                <a href="{{$contr_name}}"><button class="btn btn-success" type="button">返回</button></a>
                            </div>
                        </div>
                    </form>
                </div>
...
<script type="text/javascript">
    ...
    function showSuccess(res){
        layer.ready(function(){
            layer.close(index);
            if(0 == res.code){
                layer.alert(res.msg, {title: '友情提示', icon: 1, closeBtn: 0}, function(){window.location.href = res.data;});
