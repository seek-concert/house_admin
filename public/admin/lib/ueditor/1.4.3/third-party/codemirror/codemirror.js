    ...
    function inText(stream, state) {
        ...
        if (ch == "<") {
            if (stream.eat("!")) {
                ...
                else if (stream.match("--")) return chain(inBlock("common", "-->"));
...
CodeMirror.defineMode("css", function(config) {
    ...
    return {
        ...
        token: function(stream, state) {
            ...
            else if (context == "{" && type != "common") state.stack.push("rule");
            return style;
        },
